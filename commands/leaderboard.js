...
module.exports.run = async (bot, message, args) => {
    ...
    .setDescription(`**Input a Leaderboard Option**\n\nCoin Leaderboard: wd!leaderboard coins\nFresh gun Leaderboard: wd!leaderboard gun\nfarm Leaderboard: wd!leaderboard farm\nhouse Leaderboard: wd!leaderboard house`)
    .setColor("#FF0000")
